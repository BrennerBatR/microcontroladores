...
EECON2 equ 018Dh ;# 
	FNROOT	_main
	FNCALL	intlevel1,_interrupcaoTMR2
	global	intlevel1
	FNROOT	intlevel1
	global	_INTCON
_INTCON	set	0xB
...
;; *************** function _main *****************
;; Defined at:
;;		line 10 in file "C:\Users\Brenn\OneDrive\Documents\Unifei\Micro\microcontroladores\exercicio3\exe3.c"
...
psect	maintext,global,class=CODE,delta=2,split=1,group=0
	file	"C:\Users\Brenn\OneDrive\Documents\Unifei\Micro\microcontroladores\exercicio3\exe3.c"
	line	10
global __pmaintext
...
GLOBAL	__end_of_main
	__end_of_main:
	signat	_main,90
	global	_interrupcaoTMR2

;; *************** function _interrupcaoTMR2 *****************
;; Defined at:
;;		line 5 in file "C:\Users\Brenn\OneDrive\Documents\Unifei\Micro\microcontroladores\exercicio3\exe3.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
psect	text1,local,class=CODE,delta=2,merge=1,group=0
	line	5
global __ptext1
__ptext1:	;psect for function _interrupcaoTMR2
psect	text1
	file	"C:\Users\Brenn\OneDrive\Documents\Unifei\Micro\microcontroladores\exercicio3\exe3.c"
	line	5
	global	__size_of_interrupcaoTMR2
	__size_of_interrupcaoTMR2	equ	__end_of_interrupcaoTMR2-_interrupcaoTMR2
	
_interrupcaoTMR2:	
;incstack = 0
	opt	stack 7
; Regs used in _interrupcaoTMR2: []
...
interrupt_function:
	...
	movwf	saved_w
	swapf	status,w
	movwf	(??_interrupcaoTMR2+0)
	movf	fsr0,w
	movwf	(??_interrupcaoTMR2+1)
	movf	pclath,w
	movwf	(??_interrupcaoTMR2+2)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	btemp+1,w
	movwf	(??_interrupcaoTMR2+3)
...
i1l16:	
	movf	(??_interrupcaoTMR2+3),w
	movwf	btemp+1
	movf	(??_interrupcaoTMR2+2),w
	movwf	pclath
	movf	(??_interrupcaoTMR2+1),w
	movwf	fsr0
	swapf	(??_interrupcaoTMR2+0)^0FFFFFF80h,w
	movwf	status
	swapf	saved_w,f
	swapf	saved_w,w
	retfie
	opt stack 0
GLOBAL	__end_of_interrupcaoTMR2
	__end_of_interrupcaoTMR2:
	signat	_interrupcaoTMR2,89
global	___latbits
___latbits	equ	2
	global	btemp
	btemp set 07Eh
