...
EECON2 equ 018Dh ;# 
	FNROOT	_main
	FNCALL	intlevel1,_interruptTMR0
	global	intlevel1
	FNROOT	intlevel1
	global	_PORTC
_PORTC	set	0x7
...
;; *************** function _main *****************
;; Defined at:
;;		line 13 in file "C:\Users\Brenn\OneDrive\Documents\Unifei\Micro\microcontroladores\exercicio4\exe4.c"
...
psect	maintext,global,class=CODE,delta=2,split=1,group=0
	file	"C:\Users\Brenn\OneDrive\Documents\Unifei\Micro\microcontroladores\exercicio4\exe4.c"
	line	13
global __pmaintext
...
l498:	
;exe4.c: 16: OPTION_REG = 0b10000100;
	movlw	low(084h)
...
GLOBAL	__end_of_main
	__end_of_main:
	signat	_main,89
	global	_interruptTMR0

;; *************** function _interruptTMR0 *****************
;; Defined at:
;;		line 5 in file "C:\Users\Brenn\OneDrive\Documents\Unifei\Micro\microcontroladores\exercicio4\exe4.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
psect	text1,local,class=CODE,delta=2,merge=1,group=0
	line	5
global __ptext1
__ptext1:	;psect for function _interruptTMR0
psect	text1
	file	"C:\Users\Brenn\OneDrive\Documents\Unifei\Micro\microcontroladores\exercicio4\exe4.c"
	line	5
	global	__size_of_interruptTMR0
	__size_of_interruptTMR0	equ	__end_of_interruptTMR0-_interruptTMR0
	
_interruptTMR0:	
;incstack = 0
	opt	stack 7
; Regs used in _interruptTMR0: [wreg]
...
interrupt_function:
	...
	movwf	saved_w
	swapf	status,w
	movwf	(??_interruptTMR0+0)
	movf	fsr0,w
	movwf	(??_interruptTMR0+1)
	movf	pclath,w
	movwf	(??_interruptTMR0+2)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	btemp+1,w
	movwf	(??_interruptTMR0+3)
	ljmp	_interruptTMR0
psect	text1
	line	6
...
i1l20:	
	movf	(??_interruptTMR0+3),w
	movwf	btemp+1
	movf	(??_interruptTMR0+2),w
	movwf	pclath
	movf	(??_interruptTMR0+1),w
	movwf	fsr0
	swapf	(??_interruptTMR0+0)^0FFFFFF80h,w
	movwf	status
	swapf	saved_w,f
	swapf	saved_w,w
	retfie
	opt stack 0
GLOBAL	__end_of_interruptTMR0
	__end_of_interruptTMR0:
	signat	_interruptTMR0,89
global	___latbits
___latbits	equ	2
	global	btemp
	btemp set 07Eh
