...
EECON2 equ 018Dh ;# 
	FNROOT	_main
	FNCALL	intlevel1,_interrupcaoTMR1
	global	intlevel1
	FNROOT	intlevel1
	global	_T1CON
_T1CON	set	0x10
...
;; *************** function _main *****************
;; Defined at:
;;		line 12 in file "C:\Users\Brenn\OneDrive\Documents\Unifei\Micro\microcontroladores\exercicio2\exer2.c"
...
psect	maintext,global,class=CODE,delta=2,split=1,group=0
	file	"C:\Users\Brenn\OneDrive\Documents\Unifei\Micro\microcontroladores\exercicio2\exer2.c"
	line	12
global __pmaintext
...
l500:	
;exer2.c: 16: TMR1L = 0xDC;
	movlw	low(0DCh)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(14)	;volatile
	line	17
;exer2.c: 17: TMR1H = 0x0B;
	movlw	low(0Bh)
	movwf	(15)	;volatile
	line	18
	
l502:	
;exer2.c: 18: INTCON |= (1<<7) | (1<<6);
	movlw	low(0C0h)
	movwf	(??_main+0)+0
	movf	(??_main+0)+0,w
	iorwf	(11),f	;volatile
...
GLOBAL	__end_of_main
	__end_of_main:
	signat	_main,89
	global	_interrupcaoTMR1

;; *************** function _interrupcaoTMR1 *****************
;; Defined at:
;;		line 5 in file "C:\Users\Brenn\OneDrive\Documents\Unifei\Micro\microcontroladores\exercicio2\exer2.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
psect	text1,local,class=CODE,delta=2,merge=1,group=0
	line	5
global __ptext1
__ptext1:	;psect for function _interrupcaoTMR1
psect	text1
	file	"C:\Users\Brenn\OneDrive\Documents\Unifei\Micro\microcontroladores\exercicio2\exer2.c"
	line	5
	global	__size_of_interrupcaoTMR1
	__size_of_interrupcaoTMR1	equ	__end_of_interrupcaoTMR1-_interrupcaoTMR1
	
_interrupcaoTMR1:	
;incstack = 0
	opt	stack 7
; Regs used in _interrupcaoTMR1: [wreg+status,2+status,0]
...
interrupt_function:
	...
	movwf	saved_w
	swapf	status,w
	movwf	(??_interrupcaoTMR1+1)
	movf	fsr0,w
	movwf	(??_interrupcaoTMR1+2)
	movf	pclath,w
	movwf	(??_interrupcaoTMR1+3)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	btemp+1,w
	movwf	(??_interrupcaoTMR1+4)
	ljmp	_interrupcaoTMR1
psect	text1
	line	6
	
i1l490:	
;exer2.c: 6: if ( PIR1 & (1<<0)) {
...
;exer2.c: 7: PIR1 &= ~(1<<0);
	movlw	low(0FEh)
	movwf	(??_interrupcaoTMR1+0)+0
	movf	(??_interrupcaoTMR1+0)+0,w
	andwf	(12),f	;volatile
	line	8
	
i1l494:	
;exer2.c: 8: TMR1L = 0xDC;
	movlw	low(0DCh)
	movwf	(14)	;volatile
	line	9
	
i1l496:	
;exer2.c: 9: TMR1H = 0x0B;
	movlw	low(0Bh)
	movwf	(15)	;volatile
	goto	i1l22
	line	10
...
i1l22:	
	movf	(??_interrupcaoTMR1+4),w
	movwf	btemp+1
	movf	(??_interrupcaoTMR1+3),w
	movwf	pclath
	movf	(??_interrupcaoTMR1+2),w
	movwf	fsr0
	swapf	(??_interrupcaoTMR1+1)^0FFFFFF80h,w
	movwf	status
	swapf	saved_w,f
	swapf	saved_w,w
	retfie
	opt stack 0
GLOBAL	__end_of_interrupcaoTMR1
	__end_of_interrupcaoTMR1:
	signat	_interrupcaoTMR1,89
global	___latbits
___latbits	equ	2
	global	btemp
	btemp set 07Eh
